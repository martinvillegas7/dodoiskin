  ...
  const blocks = [
    {
      ...
      image: "/skincare-routine-minimalista-pastel.jpg",
    ...
    },
    {
      ...
      image: "/skin1004-productos-skincare-coreano.jpg",
      cta: "Ver colección",
    },
    {
      id: 3,
      ...
      image: "/skincare-tipos-de-piel-coreano.jpg",
          ...
          {blocks.map((block) => (
            <div key={block.id} className="space-y-6">
              ...
              <div className="relative h-64 md:h-80 rounded-xl overflow-hidden bg-muted">
                <img src={block.image || "/placeholder.svg"} alt={block.title} className="w-full h-full object-cover" />
              </div>

              {/* Content */}
              <div className="space-y-3">
                <h3 className="text-xl md:text-2xl font-bold text-foreground">{block.title}</h3>
                <p className="text-muted-foreground text-sm md:text-base">{block.description}</p>
              </div>
              ...
              <a
                ...
                className="inline-block px-6 py-2 text-primary font-semibold text-sm hover:underline transition"
              >
                {block.cta} →
              </a>
            </div>
